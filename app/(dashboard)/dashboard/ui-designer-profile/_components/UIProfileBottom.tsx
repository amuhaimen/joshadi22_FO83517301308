  ...
  return (
   <div className=' flex items-start gap-4 mt-6'>
        <div className=' bg-[#161616] py-4 px-6 flex-1 text-white rounded-3xl space-y-6'>
          {/* one */}
          <div>
          <h2 className=' text-white text-xl font-semibold'>Former and Active Contracts</h2>
          <div className=' flex items-center gap-4   mt-1'>
            <div className=' bg-[#313131]/20 border border-[#5c5c5c] py-4 px-3  flex items-center gap-3 rounded-[10px] flex-1'>
              ...
              <h3 className=' text-base text-white font-semibold'>ABC corp</h3>
            ...
            <div className=' bg-[#313131]/20 border border-[#5c5c5c] py-4 px-3  flex items-center gap-3 rounded-[10px] flex-1'>
              ...
              <h3 className=' text-base text-white font-semibold'>XYZ Agency</h3>
          ...
          {/* two */}
          <div>
          <h2 className=' text-white text-xl font-semibold'>Former Experience</h2>
          <div className=' flex items-center gap-4   mt-1'>
            <div className=' bg-[#313131]/20 border border-[#5c5c5c] py-4 px-3  flex items-center gap-3 rounded-[10px] flex-1'>
              <div className='ui_profile_icons_bg p-[10px] rounded-full'>
          ...
          <h2 className=' text-white text-xl font-semibold'>Skills</h2>
           <div className=' flex items-center gap-7 mt-3'>
              <div className=' flex flex-col items-center px-7'>
                ...
                <h2 className=' text-base text-white font-semibold mt-3'>Adobe XD</h2>
              </div>
              <div className=' flex flex-col items-center px-7'>
                <Image src={figmaImg} alt=' figma logo'/>
                <h2 className=' text-base text-white font-semibold mt-3'>Figma</h2>
              </div>
              <div className=' flex flex-col items-center px-7'>
                <Image src={sketchImg} alt=' sketch logo '/>
                <h2 className=' text-base text-white font-semibold mt-3'>Sketch</h2>
              </div>
           </div>
          </div>
          {/* four */}
        ...
        <div className=' bg-[#161616] py-4 px-6  flex-1 text-white rounded-3xl'>2</div>
      </div>
  )
}
