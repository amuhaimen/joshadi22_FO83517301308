...
import FeedbackCard from '../../../../_components/reusable/FeedbackCard';
import Link from 'next/link';
import DropDown from '@/public/icons/DropDown';
import ui1 from '@/public/uiux/uiux1.png';
import ui2 from '@/public/uiux/uiux2.png';
import ui3 from '@/public/uiux/uiux3.png';

// design screens interface
...
const designScreensData: DesignScreen[] = [
  {
...
const projects = [
    ...
    {
        name: 'Wireframes for dashboard',
        assigne: 'Phoenix Baker 2',
        empImage: emp1,
        priority: 85,
        dueDate: 'Apr 01, 2025',
        status: 'Blocked',
    ...
    {
        name: 'Prototype settings modal',
        assigne: 'Phoenix Baker 3',
        empImage: emp1,
        priority: 12,
        dueDate: 'Sep 21, 2025',
        status: "Completed",
      ...
      <div>
        ...
        <div className="flex-col flex gap-6">
          <div className="flex gap-6 flex-col lg:flex-row">
            {/* featured task  */}
            <div className="p-5 bg-[#141414]/70 rounded-t-3xl flex-1   mt-6">
              <div className=" text-white">
                <div className=" flex justify-between   pb-2">
                  <h2 className=" text-2xl font-semibold">Task Overview</h2>
                  <button className="header_buttons_bg py-2 px-3 rounded-[10px] cursor-pointer">
                    View All
                  </button>
                </div>
            ...
            <div className="p-5 bg-[#141414]/70 rounded-3xl   w-full mt-6">
              <div className=" text-white">
                <div className=" flex justify-between   pb-2">
                  ...
                  <button className="header_buttons_bg py-2 px-3 rounded-[10px] cursor-pointer text-nowrap">
                    View All
                  </button>
                </div>
                <div className=" bg-[#141414]  mt-4 rounded-t-3xl">
                  <FeedbackCard feedbacks={projects} />
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="mt-4 rounded-t-3xl">
                  <div className="flex flex-col gap-3">
                    <div className="flex flex-col gap-1">
                      <span className="  text-zinc-500 text-sm font-semibold font-Urbanist leading-tight tracking-tight">
                        Result Summary
                      </span>
                      <div className="self-stretch h-10 px-4 py-2 bg-[#1f1f1f] rounded-xl outline outline-1 outline-offset-[-1px] outline-white/5 inline-flex flex-col justify-center items-start gap-2.5">
                        <div className="text-right justify-start text-neutral-300 text-xs font-normal font-Urbanist leading-snug">
                          3/5 struggled to find the settings icon
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="self-stretch h-10 px-4 py-2 bg-[#1f1f1f] rounded-xl outline outline-1 outline-offset-[-1px] outline-white/5 inline-flex flex-col justify-center items-start gap-2.5">
                        <div className="text-right justify-start text-neutral-300 text-xs font-normal font-Urbanist leading-snug">
                          Improve visibility on mobile view
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                  ...
                  <div className="flex flex-col gap-3">
                    <div>
                      <div className="w-full h-12 px-3 py-2 bg- [#191919] rounded-tl-xl rounded-tr-xl outline outline-1 outline-offset-[-1px] outline-white/5  flex justify-start items-center gap-2.5">
                        ...
                        >
                          <path
                            d="M10.0234 9.99995C10.0234 8.15901 11.5158 6.66663 13.3568 6.66663C15.1977 6.66663 16.6901 8.15905 16.6901 9.99995C16.6901 11.8409 15.1977 13.3333 13.3568 13.3333C11.5158 13.3333 10.0234 11.8409 10.0234 9.99995Z"
                            fill="#00BCFF"
                          />
                          <path
                            d="M3.35742 16.6667C3.35742 14.8257 4.8498 13.3334 6.69074 13.3334L8.46711 12.3955L10.0241 13.3334V16.6667C10.0241 18.5077 8.53168 20 6.69074 20C4.8498 20 3.35742 18.5076 3.35742 16.6667Z"
                            fill="#00CF7F"
                          />
                          <path
                            d="M10.0248 0L8.21094 3.15117L10.0248 6.66664H13.3113C15.1523 6.66664 16.6446 5.17426 16.6446 3.33332C16.6446 1.49238 15.1523 0 13.3113 0H10.0248Z"
                            fill="#FF7361"
                          />
                          <path
                            d="M3.31055 3.33332C3.31055 5.17426 4.80293 6.66664 6.64387 6.66664L8.41211 7.34961L10.0239 6.66664V0H6.64383C4.80293 0 3.31055 1.49238 3.31055 3.33332Z"
                            fill="#FF4D12"
                          />
                          <path
                            d="M3.35742 9.99999C3.35742 11.841 4.8498 13.3333 6.69074 13.3333H10.0241V6.66663H6.69074C4.8498 6.66663 3.35742 8.15905 3.35742 9.99999Z"
                            fill="#B659FF"
                          />
                        </svg>

                        <div className="justify-start text-white text-sm font-semibold font-Urbanist leading-tight tracking-tight">
                          Figma Files
                        </div>
                      </div>
                        ...
                        <div className="w-60 inline-flex justify-start items-center gap-2">
                          <div className="w-32 flex justify-start items-center gap-2">
                            <div className="flex justify-start items-center gap-1">
                              <Link
                                className="text-right justify-start text-green-400 text-xs font-normal font-Urbanist leading-snug"
                                href={"/figma/main_ui_design"}
                              >
                                /figma/main_ui_design
                              </Link>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="w-60 inline-flex justify-start items-center gap-2">
                          <div className="w-32 flex justify-start items-center gap-2">
                            <div className="flex justify-start items-center gap-1">
                              <Link
                                className="text-right justify-start text-green-400 text-xs font-normal font-Urbanist leading-snug"
                                href={"/Notion/User_Research_Summary"}
                              >
                                /Notion/User_Research_Summary
                              </Link>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="w-full   px-5 py-4 bg- [#191919] rounded-xl  outline outline-1 outline-offset-[-1px] outline-white/5  flex justify-between items-center gap-2.5">
                      ...
                      <Link href={""}>
                        ...
                        >
                          <path
                            d="M9.99935 12.0833L9.99935 3.75M9.99935 12.0833C9.41583 12.0833 8.32562 10.4214 7.91602 10M9.99935 12.0833C10.5829 12.0833 11.6731 10.4214 12.0827 10"
                            stroke="#E9E9EA"
                            strokeWidth="1.5"
                            strokeLinecap="round"
          ...
          <div className=" bg-[#161616] p-4 rounded-3xl">
            <div className=" flex justify-between items-center  ">
              <h3 className=" text-xl text-white "> Current Design Screens</h3>
              <button className="  common_btn_bg  text-sm text-white font-semibold py-2 px-3 rounded-[10px] cursor-pointer">
                View All
              </button>
            </div>
            {/* design screens data will be map here  */}

            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              {designScreensData.map((screen, index) => (
                <div
                  key={index}
                  className=" p-4 bg-[#161616] border border-[#373737] rounded-2xl "
                >
                  <div className="w-auto h-[250px] overflow-hidden rounded-[10px]">
                    <Image
                      src={screen.imageUrl}
                      alt={screen.title}
                      className=" h-[250px]"
                  ...
                  <h3 className=" text-base text-white font-semibold mt-4">
                    {screen.title}
                  </h3>
                  ...
                  <Link
                    href="#"
                    className=" text-base text-[#21AF68] font-semibold flex justify-center items-center border border-[#373737] py-1 rounded-full mt-2 hover:border-[#21AF68] transition-all duration-300 "
                  >
                    Open in Figma
                  </Link>
                </div>
          ...
          {/* last section */}
          <div className="  bg-[#181818] rounded-[16px] p-4 flex flex-col">
            <div className="flex justify-between">
              ...
              <button className="cursor-pointer h-8 px-4 py-2 rounded-[20px] outline outline-1 outline-offset-[-1px] outline-zinc-700 inline-flex flex-col justify-center items-center gap-1.5">
                <div className="w-16 inline-flex justify-start items-center gap-1">
                  <div className="w-11 text-nowrap justify-start text-gray-200 text-[10px] font-normal font-Urbanist leading-[10px]">
                    This Week
                  </div>
                  <DropDown />
                </div>
            ...
            <div className="w-full overflow-x-auto">
              <table className="w-full min-w-5xl   mt-5    ">
                <thead>
                  <tr>
                    <th className="     px-3 py-6  text-start text-white text-sm font-semibold font-Urbanist leading-tight tracking-tight">
                      10 Aug 2025
                    </th>
                    <th className="  px-3 py-6  text-start text-white text-sm font-semibold font-Urbanist leading-tight tracking-tight">
                      15 Aug 2025
                ...
                <tbody>
                  <tr>
                    <td className="  bg-[#1F1F1F] py-5 px-3">
                      {/* cards  */}
